export function RefundPopup({hidden = false}: {hidden: boolean}) {

    return (
        <div id="popup-modal" tabIndex={-1} className={` ${hidden ? "hidden" : ""} flex overflow-y-auto overflow-x-hidden absolute z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
